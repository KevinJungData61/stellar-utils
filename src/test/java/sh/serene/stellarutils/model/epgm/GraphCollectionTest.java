...
public class GraphCollectionTest {
    ...
    public void joinVertexCollections() throws Exception {
        ...
        List<VertexCollection> verticesOriginal = graphCollection.getVertices().collectAsList();
        ...
        // join vertices
        Dataset<VertexCollection> verticesJoined = graphCollection.joinVertexCollections(verticesNew);
    ...
    public void joinEdgeCollections() throws Exception {
        ...
        // one to be changed, another to be left unchanged
        List<EdgeCollection> edgesOriginal = graphCollection.getEdges().collectAsList();
        ...
        // join vertices
        Dataset<EdgeCollection> edgesJoined = graphCollection.joinEdgeCollections(edgesNew);
